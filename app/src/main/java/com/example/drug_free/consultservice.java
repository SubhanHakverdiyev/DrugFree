...
public class consultservice extends AppCompatActivity implements ConversationDelegate{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Smooch.init(getApplication(), new Settings("5fa69de9f0f418000cd90483"), new SmoochCallback() {
            ...
            public void run(SmoochCallback.Response response) {
                Smooch.setConversationDelegate((ConversationDelegate) consultservice.this);
